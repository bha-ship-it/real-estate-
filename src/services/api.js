...
export const auditLogApi = {
  getAll: async (page = 0, size = 20) => {
    try {
      return await request(`/api/audit-logs?page=${page}&size=${size}`);
    } catch (_) {
...
export const zoningApi = {
  getByPropertyId: async (propertyId) => {
    return request(`/api/zoning/${propertyId}`);
  },
};

export const floodZoneApi = {
  getByPropertyId: async (propertyId) => {
    return request(`/api/flood-zone/${propertyId}`);
  },
};

export const permitApi = {
  getByPropertyId: async (propertyId) => {
    return request(`/api/permits/property/${propertyId}`);
  },
  getAll: async () => {
